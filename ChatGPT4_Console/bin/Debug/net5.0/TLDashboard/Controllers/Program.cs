    ...
    class Program
    {
        ...
        static async System.Threading.Tasks.Task Main(string[] args)
        {
            ...
            foreach (string filepath in filepaths)
            {
                ...
                string fileContent = string.Concat("Write a html functional requirement output for the below c# code: ", Environment.NewLine, System.IO.File.ReadAllText(filepath));
                try
                {
                    ...
                    Result.Append(string.Concat("<p>", await ChatGPTCall(fileContent), "</p>"));                   
        ...
        public async static Task<string> ChatGPTCall(string input)
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", "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");
